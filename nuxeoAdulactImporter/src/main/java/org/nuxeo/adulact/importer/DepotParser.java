...
public class DepotParser {
    ...
    public DepotParser(DocumentModel rootDoc) {
    ...
    public DocConfig getDocCreationConfig(String tagName) {
    ...
    public List<AttributeConfig> getAttributConfigs(String tagName) {
